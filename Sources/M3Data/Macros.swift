...
public macro Attribute() = #externalMacro(module: "M3DataMacros", type: "AttributeMacro")
...
@attached(accessor, names: named(get), named(set))
@attached(peer, names: prefixed(_))
public macro Relationship2(inverse: AnyKeyPath) = #externalMacro(module: "M3DataMacros", type: "Relationship2Macro")
